...
public class MagicTextView extends AppCompatTextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            if(a.hasValue(R.styleable.MagicTextView_tv_background)){
                Drawable background = a.getDrawable(R.styleable.MagicTextView_tv_background);
                if(background != null){
                    this.setBackgroundDrawable(background);
                }else{
                    this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_tv_background, 0xff000000));
                }
            }
            ...
            if(a.hasValue(R.styleable.MagicTextView_strokeColor)){
                ...
                switch(a.getInt(R.styleable.MagicTextView_strokeJoinStyle, 0)){
                    case(0): strokeJoin = Paint.Join.MITER; break;
                    case(1): strokeJoin = Paint.Join.BEVEL; break;
                    case(2): strokeJoin = Paint.Join.ROUND; break;
                }
